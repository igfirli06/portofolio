...
def get_portfolio_data():
    return {
        ...
        "about": (
            "Lulusan Teknik Informatika yang berdedikasi dalam membangun"
        ...
        "projects": [
            {
                ...
                "desc": (
                    "Sistem berbasis website untuk mendeteksi blackspot dan"
                ...
                "pipeline": [
                    {
                        "step": "01",
                        "label": "Input Gambar Udang",
                        "sub": "upload via web",
                    },
                    {
                        "step": "02",
                        "label": "Resize 640x640",
                        "sub": "preprocessing",
                    },
                    {
                        "step": "03",
                        "label": "YOLO Detection",
                        "sub": "deteksi + remove background",
                    },
                    {
                        "step": "04",
                        "label": "OpenCV Color Extraction",
                        "sub": "HSV, CIELab, RGB",
                    },
            ...
            },
            {
                ...
                "desc": (
                    "Sistem pemantauan keamanan karyawan untuk area zona"
            ...
            },
            {
                ...
                "desc": (
                    "Sistem berbasis website untuk mendeteksi kandungan gizi"
            ...
            },
            {
                ...
                "desc": (
                    "Sistem otomasi untuk pengelolaan konfigurasi firewall"
...
def project_detail(pid):
    ...
    return render_template(
        "architecture.html", data=portfolio_data, project=project
    )
